...
[["condition_a", 1], "DashedSentence", {s: "yöneticilerin", "aşçısı", "mutfakta sürekli", "zıpladılar"}],
...
[["condition_d", 40], "DashedSentence", {s: "kadının", "ninesi", "geçen seneye göre", "dinçleşti"}][["filler", 101], "DashedSentence", {s: "Adamın", "annesi", "fenalaşınca", "inek", "kurban", "ettiler"}],
