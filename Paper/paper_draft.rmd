...
The aim of this study was examine the question of whether the agreement attraction effect @LagoEtAl:2019 found is mediated by the morphological ambiguity of the head noun.
...
As seen in example (\ref{exp1_item}), unlike @LagoEtAl:2019's experimental sentences, the head nouns in our experiment are consonant-final and are therefore unambigously marked for posessive case -- the accusative form of *'yardımcı'* is *'XXX'*.
...
Figure \@ref(fig:exp1AvgResponse) shows the percentage of "acceptable" answers as a function of the grammatical of number the attractor noun phrase, and sentence grammaticality. While ungrammatical sentences with a plural attractor were found acceptable in `r round(100*avg_exp[[3,6]])`% of the cases, the accepability rate was only `r round(100*avg_exp[[4,6]])`% when the attractor was singular. 
This ovserved agreement attraction effect of `r round(100*(avg_exp[[3,6]]-avg_exp[[4,6]]))`%, as well as the condition averages are fairly close to Lago et al.'s attraction effect of `r round(100*(avg_exp[[7,6]]-avg_exp[[8,6]]))`%.
