...
{\centering \includegraphics[width=\maxwidth]{figure/exp1ResponseModelSepExp1-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/exp1ResponseModelSepExp2-1} 
...
%Across participants, a total sum(is.na(df_exp2_na_nofillers$ResponseYes)) items were not responded to before the 5 second deadline by length(unique(df_exp2_na_nofillers$subject)) different participants. These items were not included in the analysis. 
...
{\centering \includegraphics[width=\maxwidth]{figure/exp2ResponseModelExp2Only-1} 
