...
We recruited 79 native speakers of Turkish to participate in Experiment 2. Their average age was \Sexpr{round(mean(form_exp2$Age))}, ranging from \Sexpr{min(form_exp2$Age)} to \Sexpr{max(form_exp2$Age)}. 
