...
%
\a. \textsc{Grammatical, Plural Verb}\\ 
...
%
\b. \textsc{Ungrammatical, Singular Verb}\\ 
...
Prior to the start of the experiment, participants provided demographic information, as well as informed consent to participate in the experiment.
...
#                                          (cUngrammatical * cAttractorPlural + 1| subject) +
#                                          (cUngrammatical * cAttractorPlural + 1| item),  
#! *Utku* Can we omit this one out? We do not have every condition for every item from each subject? It goes to minus infinity.
#! *PL* Are you talking about the starting values?
#                    data = df_merged_nofillers,
#                    family = bernoulli("probit"),
...
#! No idea what this is about. Excluding for now.
...
# TODO: Data seems to contain NAs in relevant columns; fix it
