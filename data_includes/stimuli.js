...
var defaults = [
    ...
    "Form", {
        ...
        continueMessage: "Devam etmek i?in buraya t?klay?n?z.",
        obligatoryCheckboxErrorGenerator: function (field) { return "Bu alan? doldurman?z gerekmektedir." },
        obligatoryErrorGenerator: function (field) { return "Bu alan? doldurman?z gerekmektedir."; },
        obligatoryRadioErrorGenerator: function (field) { return "Se?eneklerden birini se?iniz."; }
